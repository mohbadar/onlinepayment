package af.asr.opbo.infrastructure.audit;

import static af.asr.opbo.infrastructure.constant.ApplicationGenericConstants.APPLICATION_ID;
import static af.asr.opbo.infrastructure.constant.ApplicationGenericConstants.APPLICATION_NAME;

import java.net.UnknownHostException;
import java.time.LocalDateTime;
import java.time.ZoneOffset;

import af.asr.opbo.infrastructure.audit.data.AuditRequestDto;
import af.gov.anar.core.infrastructure.exception.common.ExceptionUtils;
import af.asr.opbo.infrastructure.audit.builder.AuditRequestBuilder;
import af.asr.opbo.infrastructure.audit.handler.AuditHandler;
import af.gov.anar.lib.logger.Logger;
import af.asr.opbo.infrastructure.constant.ApplicationGenericConstants;
import af.asr.opbo.infrastructure.enumeration.AuditEvent;
import af.asr.opbo.infrastructure.enumeration.Components;
import af.asr.opbo.infrastructure.base.HostService;
import af.asr.opbo.infrastructure.base.UserService;
import af.asr.opbo.infrastructure.util.LoggerFactory;
