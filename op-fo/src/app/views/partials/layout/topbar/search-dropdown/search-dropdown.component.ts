...
import { TopbarSearchService } from '../topbar-service';
import { GeneralSearchDTO } from './general-search.dto';
...
export class SearchDropdownComponent implements OnInit {
	...
	constructor(
		...
		private topbarSearchService: TopbarSearchService,
	...
	search(e) {
		console.log("e::::::::", e);
		this.data = null;
		let dto = new GeneralSearchDTO();

		if (e.target.value.length > 0) {
			this.loading = true;
			dto.name = e.target.value;
			console.log("dto.name:::::", dto.name);
			this.topbarSearchService.generalSearch(dto).subscribe(res => {
