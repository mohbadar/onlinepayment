...
@Component({
  selector: 'kt-debit-organization-ledger',
  templateUrl: './debit-organization-ledger.component.html',
  styleUrls: ['./debit-organization-ledger.component.scss']
})
export class DebitOrganizationLedgerComponent implements OnInit {
  ...
  @ViewChild('wizard', { static: true }) el: ElementRef;
	...
	submit() {
		...
		console.log("Form Data", data)
		 ...
		 this.spinner.show();
        this.organizationService.saveRectifiedJournalDebit(data).subscribe(
            response => {
                this.spinner.hide();
                this.myForm.reset()
            ...
            err => {
                this.spinner.hide();
                const msg = 'There is no organization with this id';
                this.layoutUtilService.showActionNotification(msg);
            }
        );
	}
